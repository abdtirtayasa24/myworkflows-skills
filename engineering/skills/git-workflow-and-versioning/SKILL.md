...
Target ~100 lines per commit/PR. Changes over ~1000 lines should be split. See the splitting strategies in [code-reviewer](../code-reviewer/SKILL.md) for how to break down large changes.
