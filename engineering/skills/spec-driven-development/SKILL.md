...
Execute tasks one at a time following [incremental-implementation](../incremental-implementation/SKILL.md) and [test-driven-development](../test-driven-development/SKILL.md). Use [context-engineering](../context-engineering/SKILL.md) to load the right spec sections and source files at each step rather than flooding the agent with the entire spec.
