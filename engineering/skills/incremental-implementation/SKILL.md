...
4. **Commit** -- save your progress with a descriptive message (see [git-workflow-and-versioning](../git-workflow-and-versioning/SKILL.md) for atomic commit guidance)
